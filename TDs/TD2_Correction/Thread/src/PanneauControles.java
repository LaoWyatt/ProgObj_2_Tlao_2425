...
public class PanneauControles extends JPanel implements ChangeListener, ItemListener {
	...
	private JPanel backgroundSliders() {
		...
		curseurBackgroundR = new JSlider(0, 100, 100);
		curseurBackgroundR.setMajorTickSpacing(25);
        ...
        curseurBackgroundG = new JSlider(0, 100, 100);
        curseurBackgroundG.setMajorTickSpacing(25);
        ...
        curseurBackgroundB = new JSlider(0, 100, 100);
        curseurBackgroundB.setMajorTickSpacing(25);
